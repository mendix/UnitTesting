 ...
 * 
 * Note: requires cloud security to be disabled
 * (please file a support ticket if this is needed, we can change this but might loose backward compatibility with Mendix 3.x)
 */
public class GenerateThumbnail extends CustomJavaAction<Boolean>
{
	...
	public Boolean executeAction() throws Exception
	{
		...
		throw new IllegalStateException("It is not possible to write thumbnail contents yet in Mendix 5");
		//MWE: there is no Core api to just write the thumbnail stream, so lets do thet ourselves...
		//TODO: 
		//Core.storeImageThumbnailContent(dstImage);
		//ImageIO.write(dstImage, "png", Corenew File(thumbfile));
